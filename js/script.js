...
const translations = {
  ...
  RUS: {
    ...
    eventsLead: "Присоединяйтесь к нашим мероприятиям и знакомьтесь с читателями",
    eventBadge1: "🎤 Встреча с автором",
    eventTitle1: "Встреча с автором: Цифровой читатель", 
    eventDate1: "📅 15 ноября 2025 • 🕕 18:00 по МСК",
    eventText1: "Интерактивная сессия с автором бестселлеров Джейн Доу, обсуждающая эволюцию цифровых привычек чтения и её новый роман 'Связанные страницы'.",
    eventBadge2: "📖 Книжный клуб",
    eventTitle2: "Виртуальный книжный клуб: Ноябрьское издание",
    eventDate2: "📅 25 ноября 2025 • 🕖 19:00 по МСК",
    eventText2: "Присоединяйтесь к нашему ежемесячному обсуждению 'Искусство чтения' известного литературного критика Маркуса Уильямса. Все участники приветствуются!",
    eventBadge3: "🎓 Мастер-класс", 
    eventTitle3: "Мастер-класс по творческому письму",
    eventDate3: "📅 5 декабря 2025 • 🕔 17:00 по МСК",
    eventText3: "Изучите основы повествования и развития персонажей с award-winning автором Томасом Ридом на этом практическом мастер-классе.",
    eventBadge4: "🎉 Мероприятие сообщества",
    eventTitle4: "Читательский челлендж конца года", 
    eventDate4: "📅 1-31 декабря 2025 • Весь день",
    eventText4: "Участвуйте в нашем ежегодном читательском челлендже! Ставьте цели, отслеживайте прогресс и выигрывайте призы за достижение вех.",
    eventBadge5: "🎨 Искусство и литература",
    eventTitle5: "Выставка дизайна книжных обложек",
    eventDate5: "📅 10 декабря 2025 • 🕕 18:30 по МСК", 
    eventText5: "Исследуйте пересечение визуального искусства и литературы с профессиональными дизайнерами книжных обложек, делящимися своим творческим процессом.",
    eventBadge6: "🌍 Глобальное чтение",
    eventTitle6: "Фестиваль мировой литературы",
    eventDate6: "📅 15-17 декабря 2025 • Разное время",
    eventText6: "Трехдневное празднование мировой литературы с участием авторов, переводчиков и читателей со всего мира.",
    eventBtn6: "Расписание"
  },
  ENG: {
